...
--  VERSIÓN PARA HOSTING COMPARTIDO (InfinityFree, cPanel, etc.)
--
--  INSTRUCCIONES:
--  1. Crea la base de datos desde el panel de tu hosting
--  2. Abre phpMyAdmin y SELECCIONA la base de datos
--  3. Importa ESTE archivo (schema_hosting.sql)
-- ============================================================
